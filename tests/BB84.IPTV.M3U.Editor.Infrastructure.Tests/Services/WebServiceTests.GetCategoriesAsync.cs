...
{
	[TestMethod]
	public async Task GetCategoriesAsyncShouldLogAndRaiseEventOnException()
	{
	...
	[TestMethod]
	public async Task GetCategoriesAsyncShouldLogAndNotifyOnNotSuccessful()
	{
		CancellationToken cancellationToken = CancellationToken.None;
		_httpClientFactoryMock.Setup(x => x.CreateClient(Constants.HttpClientName))
	...
	[TestMethod]
	public async Task GetCategoriesAsyncShouldReturnDataWhenSuccessful()
	{
		CancellationToken cancellationToken = CancellationToken.None;
		_httpClientFactoryMock.Setup(x => x.CreateClient(Constants.HttpClientName))
