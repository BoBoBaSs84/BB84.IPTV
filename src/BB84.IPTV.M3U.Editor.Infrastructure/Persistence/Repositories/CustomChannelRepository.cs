...
/// <summary>
/// Represents the repository for managing <see cref="CustomChannelEntity"/> instances.
/// </summary>
/// <param name="dbContext">The database context to be used by the repository.</param>
internal sealed class CustomChannelRepository(IDbContext dbContext) : RepositoryBase<CustomChannelEntity>(dbContext), ICustomChannelRepository
{ }
