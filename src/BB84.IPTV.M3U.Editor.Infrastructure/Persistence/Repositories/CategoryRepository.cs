...
/// <summary>
/// Represents the repository for managing <see cref="CategoryEntity"/> instances.
/// </summary>
/// <param name="dbContext">The database context to be used by the repository.</param>
internal sealed class CategoryRepository(IDbContext dbContext) : RepositoryBase<CategoryEntity>(dbContext), ICategoryRepository
{ }
