...
/// <summary>
/// Represents the repository for managing <see cref="GuideMappingEntity"/> instances.
/// </summary>
/// <param name="dbContext">The database context to be used by the repository.</param>
internal sealed class GuideMappingRepository(IDbContext dbContext) : RepositoryBase<GuideMappingEntity>(dbContext), IGuideMappingRepository
{ }