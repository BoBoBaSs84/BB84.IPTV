...
/// <summary>
/// Represents the repository for managing <see cref="CountryEntity"/> instances.
/// </summary>
/// <param name="dbContext">The database context to be used by the repository.</param>
internal sealed class CountryRepository(IDbContext dbContext) : RepositoryBase<CountryEntity>(dbContext), ICountryRepository
{ }
