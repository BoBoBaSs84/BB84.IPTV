...
/// <summary>
/// Represents the repository for managing <see cref="PlaylistEntryEntity"/> instances.
/// </summary>
/// <param name="dbContext">The database context to be used by the repository.</param>
internal sealed class PlaylistEntryRepository(IDbContext dbContext) : RepositoryBase<PlaylistEntryEntity>(dbContext), IPlaylistEntryRepository
{ }