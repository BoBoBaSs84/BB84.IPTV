...
/// <summary>
/// Represents the repository abstraction for managing <see cref="LanguageEntity"/> instances.
/// </summary>
public interface ILanguageRepository : IRepositoryBase<LanguageEntity>
{ }
