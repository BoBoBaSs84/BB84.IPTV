...
/// <summary>
/// Represents the repository abstraction for managing <see cref="CustomChannelEntity"/> instances.
/// </summary>
public interface ICustomChannelRepository : IRepositoryBase<CustomChannelEntity>
{ }
